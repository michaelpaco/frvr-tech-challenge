...
import com.michaelpaco.webinterface.util.Const.DB_NAME
    ...
    companion object {
        ...
        fun getDatabase(context: Context): LocalNotificationDatabase {
            return instance ?: synchronized(this) {
                val dbInstance = Room.databaseBuilder(context.applicationContext, LocalNotificationDatabase::class.java, DB_NAME)
